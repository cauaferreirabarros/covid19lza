...
<h2><strong>Formulário epidemiológico</strong></h2>
<p class="font-italic">Este formulário é destinado à população luzianiense e aos que trabalham na cidade. Caso trabalhe na cidade e não tenha um endereço
fixo, preencha com o endereço de onde trabalha.</p>

<form action="form.php" method="post" data-toggle="validator" onSubmit="return validarForm(this);" >
  <!-- area de campos do form -->
	<hr />
	<div class="row">
		<div class="form-group col-md-3">
		  <label for="cpf">CPF</label>
		  <input type="text" class="form-control" name="formulario['cpf']" maxLength="14" onkeypress="mascaraCPF(this,cpf);" required>
		  <div class="help-block with-errors"></div>
		</div>
		
		<div class="form-group col-md-7">
		  <label for="nome">Nome Completo</label>
		  <input type="text" class="form-control" name="formulario['nome']" required>
		  <div class="help-block with-errors"></div>
		</div>
	</div>
	<div class="row">
    <div class="form-group col-md-1">
      ...
      <input type="text" class="form-control" name="formulario['idade']" required>
	  <div class="help-block with-errors"></div>
    </div>
	
	<div class="form-group col-md-2">
      <label for="sexo">Sexo</label>
		<select class="form-control" id="sexo" name="formulario['sexo']">
	...
	<div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="formulario['telefone']" maxlength="15" required>
	  <div class="help-block with-errors"></div>
    </div>
	
	<div class="form-group col-md-5">
      <label for="endereco">Endereço</label>
      <input type="text" class="form-control" name="formulario['endereco']" required>
	  <div class="help-block with-errors"></div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="formulario['bairro']" required>
	  <div class="help-block with-errors"></div>
    </div>
    
    <div class="form-group col-md-2">
      <label for="cep">CEP</label>
      <input type="text" class="form-control" name="formulario['cep']" maxlength="10" onkeypress="mascaraCEP(this,cep);" required>
	  <div class="help-block with-errors"></div>
    </div>
  ...
  <div class="form-check">
	...
	<p class="form-group">
      <input type="hidden" class="form-control" id="BDlatitude" name="formulario['latitude']">
    </p>
	<p class="form-group">
      <input type="hidden" class="form-control" id="BDlongitude" name="formulario['longitude']">
    </p>
	
      <!-- LATITUDE -->	
	<script>
		var BDlatitude = getLocationLat();
		var BDlongitude = getLocationLong();
...
function validarForm(f) { 
	if (validarCPF(f.cpf.value)==false) { 
		...
		return false; 
	} else if (validarCEP(f.cep.value)==false) { 
		alert ("O campo CEP deve ser válido."); 
		return false; 
	} 
	return true; 
} 
